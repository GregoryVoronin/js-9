...
function findElementGreaterThan(arr, num) {
  if (Array.isArray(arr) && arr.length > 0) {
    let currentNum = arr.find(elem => elem > num);
    return currentNum != undefined ? currentNum : "Числа яке задовільняє умову не знайдено"
  } else {
    return undefined
  }
...
console.log(findElementGreaterThan([1, 2, 3, 2, 1], 3)); // Виведе 4
...
function findLastEvenNumber(arr) {
  if (Array.isArray(arr) && arr.length > 0) {
    const currentNum = arr.findLast(elem => elem % 2 === 0);
    return currentNum != undefined ? currentNum : "Парних чисел не знайдено"
  } else {
...
function getPositiveArrayValues(arr) {
  if (Array.isArray(arr) && arr.length > 0) {
    ...
    return newArr.filter(num => num > 0);
  } else {
    return "Вхідний параметр має бути масивом"
  }
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function removeAndDouble(arr, startIdx) {
  if (Array.isArray(arr) && arr.length > 0) {
    return arr.splice(0, startIdx).map(num => num * 2)
  } else {
    return "Вхідний параметр має бути масивом"
  }
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function sumAndPrint(arr) {
  if (Array.isArray(arr) && arr.length > 0) {
    ...
    return arr.reduce((num, elem) => elem += num, 0 )
  } else {
    return "Вхідний параметр має бути масивом"
  }
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function flattenSquareAndFilter(arr, threshold) {
  if (Array.isArray(arr) && arr.length > 0) {
    return arr.flat(99).map(elem => elem ** 2).filter(elem => elem > threshold);
  } else {
    return "Вхідний параметр має бути масивом"
  }
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getLastElementsSumAndPrint(arr, n) {
  if (Array.isArray(arr) && arr.length > 0) {
    ...
    return newArr.reduceRight((num, elem) => num += elem, 0);
  } else {
    return "Вхідний параметр має бути масивом"
  }
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function expandArrayByN(arr, n) {
  if (Array.isArray(arr) && arr.length > 0 && !isNaN(n)) {
    return arr.flatMap((elem) => {
      let expandedArray = [];
      for (let i = 0; i < n; i++) {
        expandedArray.push(elem)
      }
...
console.log(findLongestWord(["apple", "banana", "watermelon", "pineapple"])); // Виведе 'watermelon'
...
function calculateTotalPrice(arr) {
  if (Array.isArray(arr) && arr.length > 0) {
    return arr.reduce((totalPrice, elem) => elem.price += totalPrice, 0)
  } else {
    return 0
  }
